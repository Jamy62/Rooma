...
<body id="paymentBody">
    <div class="container">
        ...
        <div class="addNew">
        <a href="userPaymentInfoAdd.php?ptID=<?php echo $credit ?>&at=<?php echo $host ?>" class="btn">Add Credit Card</a>
        <a href="userPaymentInfoAdd.php?ptID=<?php echo $debit ?>&at=<?php echo $host ?>" class="btn">Add Debit Card</a>
        </div>
    </div>
        ...
        var clickedRow = event.target.closest('tr');
            ...
            if (clickedRow && clickedRow.dataset.pid) 
            {
                ...
                else 
                {
                    ...
                    deleteLink.href = 'userPaymentInfoDelete.php?pID=' + paymentId + '&at=<?php echo $host ?>';
                }
            }
        };
